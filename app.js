...
function renderIntro() {
  return `<section class="intro" id="intro"><div class="intro-inner"><img class="intro-logo" src="./poliport-logo.png" alt="Poliport"><div class="gullseye-word">GullsEye</div><div class="intro-copy">Güvenli sevkiyat · Kontrollü saha kabulü</div><div class="load-track"><i></i></div><div class="intro-credit">Poliport GullsEye · S. Seymen tarafından hazırlanmıştır.</div></div></section>`;
}
...
function carrierNav() {
  ...
  const items = [
    ["home", "01", "Ana Sayfa"], ["vehicles", "02", "Araç / Sürücü Ekle"], ["pool", "03", "Onaylı Havuz"], ["requests", "04", "Talep Oluştur"], ["reports", "05", "Raporlar"],
  ];
...
setTimeout(() => {
  ...
  setTimeout(() => { ui.stage = "gateway"; render(); }, 470);
